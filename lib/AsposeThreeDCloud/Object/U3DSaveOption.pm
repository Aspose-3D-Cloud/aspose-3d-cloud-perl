...
#
package AsposeThreeDCloud::Object::U3DSaveOption;
...
__PACKAGE__->method_documentation({
    ...
    'export_normals' => {
    	datatype => 'boolean',
    	base_name => 'ExportNormals',
    	description => 'Gets or sets whether to export normal data.',
    	format => '',
    	read_only => '',
    		},
    'export_texture_coordinates' => {
    	datatype => 'boolean',
    	base_name => 'ExportTextureCoordinates',
    	description => 'Gets or sets whether to export texture coordinates.',
    	format => '',
    	read_only => '',
    		},
    'export_vertex_diffuse' => {
    	datatype => 'boolean',
    	base_name => 'ExportVertexDiffuse',
    	description => 'Gets or sets whether to export vertex&#39;s diffuse color.',
    	format => '',
    	read_only => '',
    		},
    'export_vertex_specular' => {
    	datatype => 'boolean',
    	base_name => 'ExportVertexSpecular',
...
__PACKAGE__->swagger_types( {
    ...
    'export_normals' => 'boolean',
    'export_texture_coordinates' => 'boolean',
    'export_vertex_diffuse' => 'boolean',
    'export_vertex_specular' => 'boolean'
} );
